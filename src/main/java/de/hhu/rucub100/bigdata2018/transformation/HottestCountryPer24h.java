...
public class HottestCountryPer24h extends StreamTransformationBase<CurrentWeather, Tuple3<String, Float, Date>> {
	...
	public static HottestCountryPer24h fromDataStream(DataStream<CurrentWeather> current) {
		return new HottestCountryPer24h(current);
	}
	
	protected HottestCountryPer24h(DataStream<CurrentWeather> current) {
		super(current);
	}
